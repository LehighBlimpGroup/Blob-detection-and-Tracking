...
# Color distribution
COLOR_PURPLE_MEAN = [10.932203389830509, -19.440677966101696]
COLOR_PURPLE_INV_COV = [[0.07913316538163431, 0.05029436660347752], [0.05029436660347752, 0.04455618868650885]]
COLOR_PURPLE_DECAY= 5.0

COLOR_GREEN_MEAN = [-19.220338983050848, 18.8135593220339]
COLOR_GREEN_INV_COV =  [[0.03511862541469479, 0.01718656168586403], [0.017186561685864032, 0.024589612819440373]]
COLOR_GREEN_DECAY= 3.0

COLOR_BLUE_MEAN = [3.0416666666666665, -14.0]
COLOR_BLUE_INV_COV = [[0.640356548413278, 0.2564800931721166], [0.2564800931721166, 0.11030296221913499]]
...
class BalloonTracker:
    ...
    def track(self, img):
        ...
        x_roi, y_roi = ux, uy
        w_roi, h_roi = int(10*val), int(10*val)
